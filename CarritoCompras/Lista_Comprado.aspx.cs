...
namespace CarritoCompras
{
    public partial class Lista_Comprado : System.Web.UI.Page
    {
        ...
        {
            if (txtCliente.Text == "" || TextBox2.Text == "" )
            {
        ...
        protected void SendEmail(object sender, EventArgs e)
        {
            ...
            correo.From = new System.Net.Mail.MailAddress("biosiwar@gmail.com");
            ...
            correo.Body = "Hola " + txtCliente.Text + " Usted ha realizado un pedido por la cantidad de : S/. " + lblTotal.Text + "\r\n" + des + "\r\n" + "Facturacion : " + txtcodcliente.Text + " " + txtnombre.Text + " " + txtapellido.Text + "\r\n" + " Con Domicilio: " + txtdomicilio.Text + " , " + txtpais.Text + " , " + txtCiudad.Text + " Codigo Postal " + txtcodpostal.Text + " Con Correo :" + txtcorreo.Text + " Número de Telefono " + txttelefono.Text + "\r\n" + " Una Vez reciba este mensaje respondanos con un 'OK', Gracias";
            ...
            smtp.Port = 587;
            smtp.Credentials = new System.Net.NetworkCredential("biosiwar@gmail.com", "siwar3312");
            smtp.EnableSsl = true;
            try
            {
                smtp.Send(correo);
