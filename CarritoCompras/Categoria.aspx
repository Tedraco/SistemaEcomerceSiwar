                ...
                <form action="">
                    ...
                    <div class="form-group">
                        <div class="col col-md-12">
                            ...
                            <asp:TextBox ID="txtCodgio" placeholder="Ingrese el codigo de categoria" runat="server" CssClass="form-control" ></asp:TextBox>
                            
                        </div>
                        <div class="col col-md-12">
                            <label for="nombre">Descripción</label>
                            <asp:TextBox ID="txtDescripcion" placeholder="Ingrese la descripción" runat="server" CssClass="form-control" ></asp:TextBox>                           
                        </div>
